...
export const defaults = {
    ...
    screenshotImageSelector: 'img[src^="/screenshot/"], img[src^="data:image/png"], img[src^="data:image/gif"], img[src^="data:image/jpeg"]',
...
function defaultSanitize(html) {
    return sanitizeHtml(stripDivsFromRichTextAnswer(sanitizeHtml(convertLinksToRelative(html), Object.assign(Object.assign({}, sanitizeOpts), { allowedTags: ['div', 'p', 'img', 'br'] }))), sanitizeOpts);
}
...
export function isUndo(e) {
    return preventIfTrue(e, (!e.altKey && !e.shiftKey && e.ctrlKey && keyOrKeyCode(e, 90)) ||
        (!e.altKey && !e.shiftKey && e.metaKey && keyOrKeyCode(e, 90)));
}
export function isRedo(e) {
    return preventIfTrue(e, (!e.altKey && !e.shiftKey && e.ctrlKey && keyOrKeyCode(e, 89)) ||
        (!e.altKey && e.shiftKey && e.metaKey && keyOrKeyCode(e, 90)));
}
